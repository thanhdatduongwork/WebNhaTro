...
@Service
public class FileSystemStorageService implements IStorage {

    private final Path rootLocation; //xác định đường dẫn gốc để lưu ảnh
    ...
    public void store(MultipartFile file, String storedFilename){
        try {
            if (file.isEmpty()){
                throw new StorageException("Failes to store empty file");
            }
    ...
    public  void  delete(String storedFilename) throws IOException {
        Path destinationFile=rootLocation.resolve(Paths.get(storedFilename)).normalize()
                .toAbsolutePath();
